...
public:
	...
	/** Determines if player is sprinting or not. */
	...
	/** Current stamina, depletes when sprinting */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Config, meta = (AllowPrivateAccess = "true"))
	float m_Stamina;
	...
	/** Current distance from the object to the player */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Config, meta = (AllowPrivateAccess = "true"))
	float m_CurrentGrabDistance = 0.f;
